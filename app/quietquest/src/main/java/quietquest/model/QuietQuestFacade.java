...
public class QuietQuestFacade {
    ...
    public void setTaskSelection(Task task) {
        questManager.setTaskSelection(task);
    }
    ...
    public Task getTaskSelection() {
        return questManager.getTaskSelection();
    }
    ...
    public void resetTaskSelection() {
        questManager.resetTaskSelection();
    }
